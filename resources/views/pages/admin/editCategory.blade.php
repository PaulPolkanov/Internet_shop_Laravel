                 ...
                 <div class="card-body">
                   <form class="row g-3" method="POST" action="/admin/changeCategory">
                     ...
                     <div class="col-12">
                       ...
                       <input type="text" class="form-control" placeholder="Название категории" name="name" value="{{$category->name}}">
                     </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <textarea class="form-control" rows="3" cols="3" placeholder="Описание продукта" name="description">{{$category->description}}</textarea>
                    </div>
                    <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-12 col-lg-1 d-grid">
                            <a href="{{ route('adminCategory') }}" class="btn btn-secondary">Отмена</a>
                        </div>
