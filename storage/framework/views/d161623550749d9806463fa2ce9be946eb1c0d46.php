             ...
             <div class="col-12 col-lg-8 d-flex">
              <div class="card border shadow-none w-100">
                <div class="card-body">
                       ...
                       <tbody>
                        <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo e(count($item->products)); ?>
                                ...
                                <a href="<?php echo e(url('/admin/editCategory', [$item->id])); ?>" class="text-warning" data-bs-placement="bottom" title="" data-bs-original-title="Edit info" aria-label="Редактировать"><i class="bi bi-pencil-fill"></i></a>
                                <a href="javascript:;" class="text-danger on_delete_category" data-bs-placement="bottom" data-id-category="<?php echo e($item->id); ?>" data-bs-toggle="modal" data-bs-target="#deleteModal" title="" data-bs-original-title="Delete" aria-label="Удалить"><i class="bi bi-trash-fill"></i></a>
                                </div>
                                </td>
                          </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <nav class="float-end mt-0" aria-label="Навигация по страницам"><?php echo e($category->onEachSide(1)->links()); ?></nav>
                </div>
              </div>
            </div>
           </div><!--end row-->
...
<?php echo $__env->make('layouts/'.$tamplate, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\server\htdocs\example-app\resources\views/pages/admin/category.blade.php ENDPATH**/ ?>