              ...
              <div class="row g-0">
                ...
                <div class="col-lg-6">
                  <div class="card-body p-4 p-sm-5">
                    ...
                    <form class="form-body" action="/admin/resetPasswordRequest" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-lock-fill"></i></div>
                              <input type="password" class="form-control radius-30 ps-5" id="inputConfirmPassword" placeholder="Confirm Password" name="remember_password">
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="d-grid gap-3">
                              <button type="submit" class="btn btn-primary radius-30">Change Password</button>
							  <a href="/admin/login" class="btn btn-light radius-30">Back to Login</a>
                            </div>
                          </div>
                        </div>
                    </form>
...
</html><?php /**PATH C:\xampp\server\htdocs\example-app\resources\views/pages/admin/resetPassword.blade.php ENDPATH**/ ?>