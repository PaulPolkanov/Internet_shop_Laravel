                        ...
                        <div class="row g-3">
                          <div class="col-12 ">
                            ...
                            <div class="ms-auto position-relative">
                              ...
                              <input type="text" class="form-control radius-30 ps-5" name="name" id="inputName" placeholder="Enter Name">
                            </div>
                          </div>
                          <div class="col-12">
                          ...
                          <div class="col-12">
                            <p class="mb-0"><a href="/admin/forgotPassword">Forgot you password</a>?</p>
                          </div>
                        </div>
                    </form>
                 </div>
...
</html><?php /**PATH C:\xampp\server\htdocs\example-app\resources\views/pages/admin/login.blade.php ENDPATH**/ ?>