...
<head>
  ...
  <link rel="icon" href="/dassets/images/favicon-32x32.png" type="image/png" />
  <!--plugins-->
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li>
                   ...
                   <li>
                    ...
                    <li><hr class="dropdown-divider"></li>
                    <li>
                      <a class="dropdown-item" href="/admin/loguot">
                         <div class="d-flex align-items-center">
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            <li>
              ...
              <ul>
                <li> <a href="/admin"><i class="bi bi-circle"></i>Blue Dashboard</a>
                </li>
                <li> <a href="/admin"><i class="bi bi-circle"></i>Color Dashboard</a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul>
                <li> <a href="<?php echo e(route('adminProducts')); ?>"><i class="bi bi-circle"></i>Products Grid</a>
                </li>
                <li> <a href="<?php echo e(route('adminCategory')); ?>"><i class="bi bi-circle"></i>Categories</a>
                </li>
...
</html><?php /**PATH C:\xampp\server\htdocs\example-app\resources\views/layouts/admin.blade.php ENDPATH**/ ?>